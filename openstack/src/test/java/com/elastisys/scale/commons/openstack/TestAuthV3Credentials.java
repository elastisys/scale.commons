...
public class TestAuthV3Credentials {
	...
	public void creation() {
		...
		AuthV3Credentials domainScopedCredentials = new AuthV3Credentials(new Scope("domain_id", null), "user_id",
				"pass");
		assertThat(domainScopedCredentials.getScope().getDomainId(), is("domain_id"));
		...
		AuthV3Credentials projectScopedCredentials = new AuthV3Credentials(new Scope(null, "project_id"), "user_id",
				"pass");
		assertThat(projectScopedCredentials.getScope().getProjectId(), is("project_id"));
