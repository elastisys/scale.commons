...
public class TestAuthConfig {
    ...
    public void creation() {
        ...
        assertThat(v2Auth.getV2Credentials(), is(new AuthV2Credentials("tenant", "user", "pass")));
        assertThat(v2Auth.getV3Credentials(), is(nullValue()));

        // v3 credential creation.
        AuthConfig v3Auth = new AuthConfig("https://keystone.host:5000/v3/", null,
                new AuthV3Credentials(new Scope(null, "project_id"), "user_id", "pass"));
        v3Auth.validate();
        ...
        assertThat(v3Auth.getV3Credentials(),
                is(new AuthV3Credentials(new Scope(null, "project_id"), "user_id", "pass")));
    }

    @Test(expected = IllegalArgumentException.class)
    public void missingKeystoneUrl() {
        new AuthConfig(null, null, new AuthV3Credentials(new Scope(null, "project_id"), "user_id", "pass"));
    }
    ...
    public void specifyingBothV2AndV3Credentials() {
        new AuthConfig("https://keystone.host:5000/v3/", new AuthV2Credentials("tenant", "user", "pass"),
                new AuthV3Credentials(new Scope(null, "project_id"), "user_id", "pass"));
    }
}
