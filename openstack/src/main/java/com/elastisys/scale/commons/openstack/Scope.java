...
/**
 * Authentication scope to use for authentication against version 3 of the
 * <a href=
...
public class Scope {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Scope) {
            ...
            return Objects.equal(this.domainId, that.domainId) && Objects.equal(this.projectId, that.projectId);
        }
        return false;
    }
