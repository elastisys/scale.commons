...
public class TestSetDiff {
	...
	public void testDiffer() {
		...
		// add one, keep one
		SetDiff<String> addOneKeepOne = new SetDiff<>(set("1.2.3.1"), set(
				"1.2.3.1", "1.2.3.2"));
		...
		// remove one, keep one
		SetDiff<String> removeOneKeepOne = new SetDiff<>(set("1.2.3.1",
				"1.2.3.2"), set("1.2.3.1"));
		...
		// add, remove, keep
		SetDiff<String> addAndRemove = new SetDiff<>(set("1.2.3.1", "1.2.3.2",
				"1.2.3.3"), set("1.2.3.1", "1.2.3.4"));
	...
	public void fromEmptySet() {
		...
		SetDiff<String> fromEmptyToDouble = new SetDiff<>(null, set("1.2.2",
				"1.2.3"));
	...
	public void toEmptySet() {
		...
		SetDiff<String> fromDoubleToEmptyTo = new SetDiff<>(set("1.2.2",
				"1.2.3"), null);
