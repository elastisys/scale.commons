...
public class TestUtcTime {
    ...
    public void now() {
        ...
        try {
            ...
            assertThat(UtcTime.now(), is(DateTime.parse("2013-01-10T11:00:00.000Z")));
    ...
    public void parseWithFormatter() {
        ...
        DateTimeFormatter formatter = DateTimeFormat.forPattern("dd/MMM/yyyy:HH:mm:ss Z").withLocale(Locale.US);
