...
public class TestTimeUtils {
	...
	public void testDurationAsString() {
		...
		Duration oneDayPlus = new Duration(
				1 * 24 * 3600 * 1000 + 60 * 55 * 1000 + 10 * 1000);
		Duration oneDay = new Duration(1 * 24 * 3600 * 1000);
		Duration hours = new Duration(
				23 * 3600 * 1000 + 1800 * 1000 + 1 * 1000);
		...
		assertThat(TimeUtils.durationAsString(oneDayPlus),
				is("24 hours, 55 minutes, 10 seconds"));
		assertThat(TimeUtils.durationAsString(oneDay), is("24 hours"));
		assertThat(TimeUtils.durationAsString(hours),
				is("23 hours, 30 minutes, 1 second"));
		assertThat(TimeUtils.durationAsString(hour), is("1 hour"));
		assertThat(TimeUtils.durationAsString(minutes),
				is("55 minutes, 30 seconds"));
