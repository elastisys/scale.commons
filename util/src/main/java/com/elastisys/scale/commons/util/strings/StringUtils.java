...
public class StringUtils {
	...
	private StringUtils() {
		throw new UnsupportedOperationException(StringUtils.class.getName()
				+ " not instantiable");
	}
	...
	public static String replaceAll(String string,
		...
		for (Entry<String, String> substitution : substitutions.entrySet()) {
			...
			String replacement = Optional.fromNullable(substitution.getValue())
					.or("null");
	 ...
	 * 
	 */
	public static class StringPrependFunction implements
