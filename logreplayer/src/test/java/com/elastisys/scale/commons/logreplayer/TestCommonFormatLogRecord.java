...
public class TestCommonFormatLogRecord {
    ...
    public void testParseCommonLogEntry() {
        ...
        assertThat(record.getFinishedProcessingTimestamp(), is(UtcTime.parse("2000-10-10T20:55:36.000Z")));
    ...
    public void testParseCombinedLogEntry() {
        String logLine = "crawl-66-249-72-68.googlebot.com " + "- " + "- " + "[22/Jan/2012:23:53:11 +0100] "
                + "\"GET /index.html\" " + "404 " + "1023 " + "\"-\" "
                + "\"Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)\"";

        CommonFormatLogRecord record = CommonFormatLogRecord.parse(logLine);

        assertThat(record.getRemoteHost(), is("crawl-66-249-72-68.googlebot.com"));
        assertThat(record.getClientIdentity(), is("-"));
        assertThat(record.getUserIdentity(), is("-"));
        assertThat(record.getFinishedProcessingTimestamp(), is(UtcTime.parse("2012-01-22T22:53:11.000Z")));
        ...
        assertThat(record.getUserAgent(),
