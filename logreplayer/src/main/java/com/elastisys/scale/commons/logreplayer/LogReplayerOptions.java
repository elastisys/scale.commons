...
public class LogReplayerOptions {
    ...
    @Option(name = "--burst-duration", metaVar = "SECONDS", usage = "The "
            ...
            + "average request rate of the frame is applied to the target URL." + " Default: " + DEFAULT_BURST_DURATION
            + " seconds.")
    public Integer burstDuration = DEFAULT_BURST_DURATION;

    @Option(name = "--connection-timeout", metaVar = "SECONDS", usage = "The " + "connection timeout (in seconds)."
            + " Default: " + DEFAULT_CONNECTION_TIMEOUT + " seconds.")
    public Integer connectionTimeout = DEFAULT_CONNECTION_TIMEOUT;

    @Option(name = "--socket-read-timeout", metaVar = "SECONDS", usage = "The " + "socket read timeout (in seconds)."
            + " Default: " + DEFAULT_SOCKET_READ_TIMEOUT + " seconds.")
