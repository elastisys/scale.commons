...
public class SteadyLoadReplayer implements Runnable {
    ...
    public SteadyLoadReplayer(String targetUrl, int requestRate, Optional<Integer> duration, int connectTimeout,
    ...
    public static void main(String[] args) {
        ...
        SteadyLoadReplayer steadyLoad = new SteadyLoadReplayer(targetUrl, requestRate, duration, connectionTimeout,
                readTimeout);
        steadyLoad.run();
    }
}
