...
public class TestElastisysAuthTokenValidator {
    ...
    public void beforeTestMethod() throws Exception {
        ...
        validator = new ElastisysAuthTokenValidator(() -> signatureKeyPair.getPublicKey());
    }
    ...
    public void validateValidToken() throws Exception {
        ...
        String signedToken = signToken(TOKEN_ISSUER, signatureKeyPair, expiration);
    ...
    public void validateTokenWithWrongIssuer() throws Exception {
        ...
        DateTime expiration = UtcTime.now().plusHours(1);
        String signedToken = signToken(wrongIssuer, signatureKeyPair, expiration);
