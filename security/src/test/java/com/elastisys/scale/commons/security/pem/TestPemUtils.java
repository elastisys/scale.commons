...
public class TestPemUtils {
    ...
    private static final File sshkeygenPrivate = new File(KEY_DIR, "sshkeygen_key");
    /** Public RSA key generated with ssh-keygen. */
    private static final File sshkeygenPublic = new File(KEY_DIR, "sshkeygen_key.pub.pem");

    /** Private RSA key generated with openssl. */
    private static final File opensslPrivate = new File(KEY_DIR, "openssl_private.pem");
    /** Public RSA key generated with openssl. */
    private static final File opensslPublic = new File(KEY_DIR, "openssl_public.pem");

    /** */
    private static final File x509Cert = new File(KEY_DIR, "x509cert.pem");
    private static final File x509CertKey = new File(KEY_DIR, "x509cert-key.pem");
    ...
    public void parseOpensslGeneratedKeys() throws Exception {
        ...
        RSAPrivateKey rsaPrivateKey = PemUtils.parseRsaPrivateKey(opensslPrivate);
        ...
        assertTrue("failed to validate signature by public key with private key",
    ...
    public void parseSshkeygenGeneratedKeys() throws Exception {
        ...
        RSAPrivateKey rsaPrivateKey = PemUtils.parseRsaPrivateKey(sshkeygenPrivate);
        assertNotNull(rsaPublicKey);
        assertNotNull(rsaPrivateKey);
    ...
    public void parseX509CertAndKey() throws Exception {
        ...
        assertThat(cert.getSubjectDN().getName(), is("CN=Client, O=Elastisys, C=SE"));
    ...
    public void testKeyStoreFromCertAndKey() throws Exception {
        ...
        KeyStore keyStore = PemUtils.keyStoreFromCertAndKey(cert, certKey, keyPassword);
        ...
        Key loadedKey = keyStore.getKey(entries.get(0), keyPassword.toCharArray());
     ...
     * @throws Exception
     */
    private static byte[] sign(String message, PrivateKey rsaPrivateKey) throws Exception {
     ...
     * @throws Exception
     */
    private boolean verifySignature(String signedMessage, byte[] signatureBytes, PublicKey rsaPublicKey)
            throws Exception {
        Signature signature = Signature.getInstance("SHA1withRSA");
