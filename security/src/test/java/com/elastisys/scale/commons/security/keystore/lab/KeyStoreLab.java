...
public class KeyStoreLab {
    ...
    public static void main(String[] args) throws Exception {
        ...
        keystorePath = KEYSTORES_DIR + "/keystore_with_storepass_and_keypass.jks";
        System.out.println("Examining JKS store " + keystorePath + " ...");
        printContents(keystorePath, "JKS", "jkspass", "keypass");

    }

    private static void printContents(String keystorePath, String keystoreType, String keystorePassword,
            String keyPassword) throws Exception {

        System.out.println("loading key store ...");
        KeyStore keyStore = KeyStore.getInstance(keystoreType);
        char[] storePassword = keystorePassword == null ? null : keystorePassword.toCharArray();
        ...
        while (aliases.hasMoreElements()) {
            ...
            System.out.println("loading key for keystore alias '" + alias + "' ...");
