...
public class TestJsonUtils {
    ...
    public void parseJsonString() throws IOException {
        ...
        JsonObject jsonObject = JsonUtils.parseJsonString(json).getAsJsonObject();
    ...
    public void parseJsonResource() throws IOException {
        ...
        JsonObject jsonObject = JsonUtils.parseJsonResource(jsonResource).getAsJsonObject();
        assertThat(jsonObject.get("a").getAsString(), is("value"));
        assertThat(jsonObject.get("b").getAsInt(), is(1));
    }
    ...
    public void parseJsonFile() throws IOException {
        File jsonFile = new File("target/test-classes/jsonutils/json-resource.txt");
        JsonObject jsonObject = JsonUtils.parseJsonFile(jsonFile).getAsJsonObject();
        assertThat(jsonObject.get("a").getAsString(), is("value"));
        assertThat(jsonObject.get("b").getAsInt(), is(1));
    }
    ...
    public void toObject() {
        JsonObject json = new JsonParser().parse("{\"a\":\"value\",\"b\":1}").getAsJsonObject();
        SomeClass expectedObject = new SomeClass("value", 1);
        assertThat(JsonUtils.toObject(json, SomeClass.class), is(expectedObject));
    }

    @Test
    public void toObjectWithTimestamp() {
        JsonObject json = new JsonParser().parse("{\"a\":\"value\",\"time\":\"2013-07-01T10:00:00.000Z\"}")
                .getAsJsonObject();
        SomeClassWithTimestamp expectedObject = new SomeClassWithTimestamp("value",
                UtcTime.parse("2013-07-01T10:00:00.000Z"));
        assertThat(JsonUtils.toObject(json, SomeClassWithTimestamp.class), is(expectedObject));
    }
    ...
    public void toObjectWithGenericType() {
        ...
        assertThat(result.get("noon"), is(UtcTime.parse("2015-01-01T12:00:00.000Z")));
        assertThat(result.get("midnight"), is(UtcTime.parse("2015-01-01T00:00:00.000Z")));
    ...
    public void testToString() {
        ...
        JsonObject jsonObject = new JsonParser().parse(rawJsonString).getAsJsonObject();
    ...
    public void toStringWithBase64EncodedDataContainingEqualsSign() {
        ...
        JsonObject json = JsonUtils.parseJsonString("{\"base64\": \"aGVsbG8geW91IQ==\"}").getAsJsonObject();
