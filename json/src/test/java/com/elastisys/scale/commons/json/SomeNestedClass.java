...
public class SomeNestedClass {
	...
	public SomeNestedClass(int primitiveValue, String string,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SomeNestedClass) {
			...
			return Objects.equal(this.primitiveValue, that.primitiveValue)
					&& Objects.equal(this.string, that.string)
