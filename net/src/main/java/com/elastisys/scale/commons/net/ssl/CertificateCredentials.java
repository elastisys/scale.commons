...
public class CertificateCredentials {
	 ...
	 */
	public CertificateCredentials(String keystorePath,
	...
	public CertificateCredentials(String keystorePath, String keystorePassword,
			String keyPassword) {
		this(DEFAULT_KEYSTORE_TYPE, keystorePath, keystorePassword,
				keyPassword);
	}
	...
	public CertificateCredentials(KeyStoreType keystoreType,
		...
		checkArgument(keystorePassword != null,
				"certificate credentials missing keystorePassword");
	...
	public KeyStoreType getKeystoreType() {
		...
		// is null
		return Optional.fromNullable(this.keystoreType)
				.or(DEFAULT_KEYSTORE_TYPE);
	}
