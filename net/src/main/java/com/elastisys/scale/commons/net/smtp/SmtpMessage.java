...
public class SmtpMessage {
	...
	public SmtpMessage(List<String> recipients, String sender, String subject,
		...
		try {
			...
			throw new IllegalArgumentException(
					"illegal email address(es) given: " + e.getMessage(), e);
		}
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(this.to, this.from, this.subject, this.content,
				this.dateSent);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SmtpMessage) {
			...
			return Objects.equal(this.to, that.to)
