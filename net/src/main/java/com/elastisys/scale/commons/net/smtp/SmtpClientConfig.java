...
public class SmtpClientConfig {
	 ...
	 *            authentication.
	 */
	public SmtpClientConfig(String smtpHost, Integer smtpPort,
			SmtpClientAuthentication authentication) {
	...
	public Integer getConnectionTimeout() {
		return Optional.fromNullable(this.connectionTimeout).or(
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(this.smtpHost, this.getSmtpPort(),
				this.authentication, this.isUseSsl(),
	...
	public void validate() throws IllegalArgumentException {
		...
		Preconditions.checkArgument(this.getSmtpPort() > 0,
				"smtpPort cannot be negative");
		Preconditions.checkArgument(this.getConnectionTimeout() >= 0,
				"negative connectionTimeout");
		Preconditions.checkArgument(this.getSocketTimeout() >= 0,
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("smtpHost", this.smtpHost)
				.add("smtpPort", this.getSmtpPort())
				.add("useSsl", this.isUseSsl())
				.add("authentication", this.authentication)
				.add("connectionTimeout", this.getConnectionTimeout())
				.add("socketTimeout", this.getSocketTimeout()).toString();
	}
}