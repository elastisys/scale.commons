...
public class SshCommandResult {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SshCommandResult) {
            ...
            return equal(this.exitStatus, that.exitStatus) && equal(this.stdout, that.stdout)
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("exitStatus", this.exitStatus).add("stdout", this.stdout)
                .add("stderr", this.stderr).toString();
    }
}
