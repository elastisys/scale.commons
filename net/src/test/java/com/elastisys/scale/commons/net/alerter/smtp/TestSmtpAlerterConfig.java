...
public class TestSmtpAlerterConfig {
	...
	public void createValidConfig() {
		...
		SmtpAlerterConfig settings = new SmtpAlerterConfig(
		...
		assertThat(settings.getSeverityFilter().getFilterExpression(),
				is(DEFAULT_SEVERITY_FILTER));
		assertThat(settings.getSmtpClientConfig(), is(smtpClientConfig()));
		settings.validate();

		// specify severity filter
		settings = new SmtpAlerterConfig(
				Arrays.asList("recipient@elastisys.com"),
		...
		settings = new SmtpAlerterConfig(noRecipients, "sender@elastisys.com",
				"subject", null, smtpClientConfig());
	...
	public void createWithNullRecipientsList() {
		new SmtpAlerterConfig(null, "sender@elastisys.com", "subject", null,
				smtpClientConfig());
	}

	@Test(expected = IllegalArgumentException.class)
	public void createWithNullRecipient() {
		new SmtpAlerterConfig(Arrays.asList("recipient@elastisys.com", null),
				"sender@elastisys.com", "subject", null, smtpClientConfig());
	}

	@Test(expected = IllegalArgumentException.class)
	public void createWithIllegalRecipientAddress() {
		new SmtpAlerterConfig(Arrays.asList("recipient.elastisys.com"),
				"sender@elastisys.com", "subject", null, smtpClientConfig());
	}
	...
	public void createWithNullSubject() {
		new SmtpAlerterConfig(Arrays.asList("recipient@elastisys.com"),
				"sender@elastisys.com", null, ".*", smtpClientConfig());
	}
	...
	public void createWithIllegalSeverityFilter() {
		new SmtpAlerterConfig(Arrays.asList("recipient@elastisys.com"),
				"sender@elastisys.com", "subject", "**", smtpClientConfig());
	}
