...
public class TestSmtpMessage {
	...
	private static final DateTime TEST_TIME = UtcTime
			.parse("2014-03-12T15:00:00.000Z");
	...
	public void createValidSmtpMessage() throws AddressException {
		...
		SmtpMessage message = new SmtpMessage(
				asList("recipient@elastisys.com"), "sender@elastisys.com",
				"subject", "content", timestamp);
		assertThat(message.getTo(),
				is(asList(email("recipient@elastisys.com"))));
		...
		message = new SmtpMessage(asList("recipient@elastisys.com"),
		...
		// multiple recipients
		message = new SmtpMessage(asList("recipient1@elastisys.com",
				"recipient2@elastisys.com"), "sender@elastisys.com", "subject",
				"content", null);
		assertThat(
				message.getTo(),
				is(asList(email("recipient1@elastisys.com"),
						email("recipient2@elastisys.com"))));

		// no subject
		message = new SmtpMessage(asList("recipient@elastisys.com"),
				"sender@elastisys.com", null, "content", null);
	...
	public void equality() {
		...
		SmtpMessage m1 = new SmtpMessage(asList("recipient@elastisys.com"),
				"sender@elastisys.com", "subject", "content", t1);

		SmtpMessage differentRecipients = new SmtpMessage(
				asList("recipient2@elastisys.com"), "sender@elastisys.com",
				"subject", "content", t1);
		SmtpMessage differentSender = new SmtpMessage(
				asList("recipient@elastisys.com"), "sender2@elastisys.com",
				"subject", "content", t1);
		SmtpMessage differentSubject = new SmtpMessage(
				asList("recipient@elastisys.com"), "sender@elastisys.com",
				"subject2", "content", t1);
		SmtpMessage differentContent = new SmtpMessage(
				asList("recipient@elastisys.com"), "sender@elastisys.com",
				"subject2", "content2", t1);
		SmtpMessage differentTime = new SmtpMessage(
				asList("recipient@elastisys.com"), "sender@elastisys.com",
		...
		SmtpMessage m1Copy = new SmtpMessage(asList("recipient@elastisys.com"),
				"sender@elastisys.com", "subject", "content", t1);
	...
	public void createWithNullRecipientList() {
		new SmtpMessage(null, "sender@elastisys.com", "subject", "content",
				null);
	}
	...
	public void createWithEmptyRecipientList() {
		...
		new SmtpMessage(empty, "sender@elastisys.com", "subject", "content",
				null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void createWithNullRecipientAddress() {
		new SmtpMessage(asList("recipient@elastisys.com", null),
				"sender@elastisys.com", "subject", "content", null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void createWithNullContent() {
		new SmtpMessage(asList("recipient@elastisys.com"),
				"sender@elastisys.com", "subject", null, null);
	}
