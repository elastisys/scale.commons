...
public class TestHttpAuthConfig {
    ...
    public void basicSanity() {
        ...
        CertificateCredentials certificateCredentials = new CertificateCredentials(KeyStoreType.PKCS12, KEYSTORE,
        ...
        assertThat(certAuth.getCertificateCredentials().get(), is(certificateCredentials));

        // basic + cert auth
        HttpAuthConfig basicAndCertAuth = new HttpAuthConfig(basicCredentials, certificateCredentials);
        assertThat(basicAndCertAuth.getBasicCredentials().isPresent(), is(true));
        assertThat(basicAndCertAuth.getCertificateCredentials().isPresent(), is(true));
        assertThat(basicAndCertAuth.getBasicCredentials().get(), is(basicCredentials));
        assertThat(basicAndCertAuth.getCertificateCredentials().get(), is(certificateCredentials));
