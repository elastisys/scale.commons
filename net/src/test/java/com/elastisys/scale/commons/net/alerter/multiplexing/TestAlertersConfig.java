...
public class TestAlertersConfig {
	...
	public void basicSanity() {
		...
		TimeInterval duplicateSuppression = new TimeInterval(10L,
				TimeUnit.MINUTES);
		AlertersConfig config = new AlertersConfig(
	...
	public void withDefaultDuplicateSuppression() {
		...
		AlertersConfig config = new AlertersConfig(asList(emailAlerter1),
	...
	public void validationOfHttpAlerter() {
		HttpAlerterConfig illegalHttpAlerter = JsonUtils.toObject(
				JsonUtils.parseJsonString(
						"{\"severityFilter\": \"ERROR\", \"destinationUrls\": null}"),
