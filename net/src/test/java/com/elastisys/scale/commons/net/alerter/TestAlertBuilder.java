...
public class TestAlertBuilder {
	...
	public void specifyAllFields() {
		...
		Alert alert = AlertBuilder.create().topic("/topic")
				.severity(AlertSeverity.INFO).message("message").timestamp(time)
	...
	public void buildWithoutTopic() {
		AlertBuilder.create().severity(AlertSeverity.INFO).message("message")
				.build();
	}
	...
	public void buildWithoutMessage() {
		AlertBuilder.create().topic("/topic").severity(AlertSeverity.INFO)
				.build();
	}
}
