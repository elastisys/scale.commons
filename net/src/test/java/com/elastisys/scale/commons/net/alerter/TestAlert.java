...
public class TestAlert {
	...
	public void basicSanity() {
		...
		Alert alert = new Alert("topic", AlertSeverity.INFO, time, "message",
				"details", metadata);
	...
	public void testEquality() {
		...
		Alert differentTopic = new Alert("othertopic", AlertSeverity.INFO,
				UtcTime.now(), "message", "details", metadata);
		Alert differentSeverity = new Alert("topic", AlertSeverity.WARN,
				UtcTime.now(), "message", "details", metadata);
		Alert differentTime = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now().plus(1), "message", "details", metadata);
		Alert differentMessage = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now(), "othermessage", "details", metadata);
		Alert differentDetails = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now(), "message", "otherdetails", metadata);
		...
		Alert differentTags = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now(), "message", "details", metadata2);
		...
		Alert differentTags2 = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now(), "message", "details", metadata3);
		Alert differentTags3 = new Alert("topic", AlertSeverity.INFO,
				UtcTime.now(), "message", "details");
